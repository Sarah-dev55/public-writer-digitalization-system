...
import { getAllAvailability, addNoWorkDay, removeNoWorkDay } from '../../services/availabilityService';
...
export default function Availability() {
  ...
  const handleToggleDay = async (dateStr, makeBlocked) => {
    try {
      if (makeBlocked) {
        const res = await addNoWorkDay(dateStr);
        if (res && res.success) {
        ...
        const res = await removeNoWorkDay(dateStr);
        if (res && res.success) {
