        ...
        {/* User Info (Top Right) */}
          {user && (
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm hidden md:block">Client services Dashboard</span>
            </div>
          )}
        </div>
      </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 flex items-center justify-center">
                ...
                >
                  {/* Book with pen icon */}
                  <rect x="8" y="6" width="24" height="28" rx="2" fill="white" stroke="#2d4a3e" strokeWidth="1.5"/>
                  <line x1="16" y1="6" x2="16" y2="34" stroke="#2d4a3e" strokeWidth="1.5"/>
                  <line x1="24" y1="6" x2="24" y2="34" stroke="#2d4a3e" strokeWidth="1.5"/>
                  <line x1="12" y1="14" x2="20" y2="14" stroke="#2d4a3e" strokeWidth="1.5"/>
                  <line x1="12" y1="18" x2="20" y2="18" stroke="#2d4a3e" strokeWidth="1.5"/>
                  {/* Pen */}
                  <path d="M26 12 L32 6 L34 8 L28 14 Z" fill="#2d4a3e"/>
                  <line x1="28" y1="14" x2="32" y2="10" stroke="#2d4a3e" strokeWidth="1"/>
                </svg>
              </div>
