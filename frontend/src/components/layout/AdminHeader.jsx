        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              >
                <div className="w-8 h-8 rounded-full overflow-hidden flex items-center justify-center bg-app-secondary text-white text-sm font-bold">
                  {user?.profileImage ? (
                    <img 
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-48 rounded-lg shadow-xl bg-app-primary/95 backdrop-blur">
                  <div className="p-3 border-b border-white/10">
                    <p className="text-sm font-semibold text-app-accent">{user?.fullName || user?.fullname || user?.name || 'Admin'}</p>
